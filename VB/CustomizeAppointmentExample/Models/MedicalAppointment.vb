...
Namespace CustomizeAppointmentExample
    ...
    Public Class MedicalAppointment
        ...
        Friend Shared Function Create(ByVal StartTime As Date, ByVal EndTime As Date, ByVal DoctorId As Integer, ByVal Location As String, ByVal PatientName As String, ByVal Note As String, ByVal FirstVisit As Boolean) As MedicalAppointment
